            ...
            <Container>
                <div className="flex flex-col gap-4">
                    ...
                    <div className="my-4">
                        ...
                        <p className="text-center text-white text-base/2"><span className="font-medium mr-1">Sala de Experiencias: </span>Km 1.4, vía Ruitoque Bajo - Acapulco.</p>
                        <p className="text-center text-white">Floridablanca, Santander</p>
                    </div>
                    <p className="text-center text-white text-sm/1">© {new Date().getFullYear()} Yarima Resort & Club de Playa. Todos los derechos reservados.</p>
                    <p className="text-center text-white text-sm/1">Desarrollado por <a href="https://mimmers.com" target="_blank" rel="noopener noreferrer" className="text-theme-gold">MIMMERS</a></p>
                </div>
            </Container>
        </footer>
    )
